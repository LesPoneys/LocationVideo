...
CLI_LOGIN varchar (200) null,
CLI_MDP varchar (200) null,
CLI_NOM varchar (200) null,
CLI_PRENOM varchar (200) null,
...
CONSTRAINT PK_CATEGORIE PRIMARY KEY(CLI_ID),
CONSTRAINT FK_CATEGORIE_CATEGORIE FOREIGN KEY(CLI_IDMERE) REFERENCES CATEGORIE(CLI_ID)
);
...
CONSTRAINT FK_LOCATION_CLIENT FOREIGN KEY(LOC_IDCLIENT) REFERENCES CLIENT(CLI_ID),
...
CONSTRAINT FK_HISTORIQUE_CLIENT FOREIGN KEY(HIS_IDCLIENT) REFERENCES CLIENT(CLI_ID)
);
